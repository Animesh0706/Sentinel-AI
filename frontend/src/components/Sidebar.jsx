...
import { Network, Database, Shield, LayoutDashboard, Sun, Settings, Hexagon } from 'lucide-react';
...
const Sidebar = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <div className="w-64 h-screen bg-cyber-sidebar border-r border-cyber-border flex flex-col justify-between shrink-0 fixed left-0 top-0 overflow-y-auto">
      ...
      <div className="px-4 py-6 border-t border-cyber-border/30">
        <p className="text-xs font-mono tracking-widest text-gray-500 mb-4 px-3">SYSTEM</p>
